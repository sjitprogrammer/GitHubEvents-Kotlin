...
class EventsLandAdapter(
    val items: List<EventsItem>,
    val context: Context,
    val onItemClickListener: OnItemClickListener
) : RecyclerView.Adapter<EventsLandAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.events_item_land, parent, false)
...
//            onItemClickListener.onClickedItem(it, item.id, position)
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val imageView: ImageView = view.findViewById(R.id.icon_image_land)
        val text_title: TextView = view.findViewById(R.id.textView_title_land)
